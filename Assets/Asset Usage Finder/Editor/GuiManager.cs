...
namespace AssetUsageFinder {
    ...
    public class GuiManager : UnityEditor.AssetModificationProcessor {
        private static string _version = "v4.0";
        ...
        static void InitCache() {
            Singleton<CacheManager>.GetOrCreate(() => {
        ...
        public static void FindReferencesToComponent(MenuCommand data) {
            ...
            UnityEngine.Object selected = data.context;
            if (!selected) return;
        ...
        private static void OpenFileWindow(UnityEngine.Object selected) {
        ...
        public static void OpenSceneWindow(UnityEngine.Object target, string scenePath) {
        ...
        private static void OpenStageWindow(UnityEngine.Object target, string stagePath) {
