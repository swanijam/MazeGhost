...
#else
    public class CameraShadeMultiManager : EffectBase, IBeforeCameraRender
#endif
    {
...
//                for (int depth = 0; depth < Depth; depth++)
//                {
//                    _copyCameraShades[camIndex, depth]._camera = _camera; //set main cam on copy shades
//                    _copyCameraShades[camIndex, depth]._context = _context; //set main cam on copy shades
//#if UNITY_2019_3_OR_NEWER
//                    //todo: no change
//#else
//                    _copyCameraShades[camIndex, depth]._pipeline = _pipeline;
//#endif
//                }
//            }
