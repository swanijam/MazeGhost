...
                return;
        ...
        public IList<Camera> RenderReflective(CameraShadeMultiManager manager, Camera sentCamera = null, bool invert = true, bool renderCam = true)
        {
...
            if (_usePreviousTexture)
            ...
            if (cameraToUse.cameraType == CameraType.Reflection || cameraToUse.cameraType == CameraType.SceneView)
                return null;
